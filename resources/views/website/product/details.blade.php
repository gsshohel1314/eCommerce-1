           ...
           <div class="row">
               <div class="col-md-5 tahsan2">
                   <div class="xzoom-container">
                      <img class="xzoom" id="xzoom-default" src="{{asset('contents/website')}}/images/gallery/preview/image1.jpg" xoriginal="{{asset('contents/website')}}/images/gallery/original/image1.jpg" alt="" />
                        <div class="xzoom-thumbs">
                        <a href="{{asset('contents/website')}}/images/gallery/original/image1.jpg"><img class="xzoom-gallery" width="80" src="{{asset('contents/website')}}/images/gallery/thumbs/image1.jpg"  xpreview="{{asset('contents/website')}}/images/gallery/preview/image1.jpg" alt=""></a>
                        <a href="{{asset('contents/website')}}/images/gallery/original/image2.jpg"><img class="xzoom-gallery" width="80" src="{{asset('contents/website')}}/images/gallery/preview/image2.jpg" alt=""></a>
                        <a href="{{asset('contents/website')}}/images/gallery/original/image3.jpg"><img class="xzoom-gallery" width="80" src="{{asset('contents/website')}}/images/gallery/preview/image3.jpg" alt=""></a>
                      </div>
                    </div>
               </div>
                   ...
                   <div class="latest-item">
                       <div class="gallery_product col-md-3">
                            <div class="featured-product">
                                <a href="#">
                                    <img src="{{asset('contents/website')}}/images/latest1.jpg" alt="featured-product-img" class="img-responsive">
                                </a>
                        ...
                        <div class="gallery_product col-md-3">
                            <div class="featured-product">
                                <a href="#"><img src="{{asset('contents/website')}}/images/latest2.jpg" alt="featured-product-img" class="img-responsive"></a>
                                <div class="overlay2 text-center">
                                    <a href="#"><i class="fa fa-heart"></i></a>
                                    <a href="#"><i class="fa fa-random"></i></a>
                                    <a href="#"><i class="fa fa-shopping-basket"></i></a>
                        ...
                        <div class="gallery_product col-md-3">
                            <div class="featured-product">
                               <a href="#"> <img src="{{asset('contents/website')}}/images/latest3.jpg" alt="featured-product-img" class="img-responsive"></a>
                                <div class="overlay2 text-center">
                                    <a href="#"><i class="fa fa-heart"></i></a>
                                    <a href="#"><i class="fa fa-random"></i></a>
                                    <a href="#"><i class="fa fa-shopping-basket"></i></a>
                        ...
                        <div class="gallery_product col-md-3">
                            <div class="featured-product">
                                <a href="#"><img src="{{asset('contents/website')}}/images/latest4.jpg" alt="featured-product-img" class="img-responsive"></a>
                                <div class="overlay2 text-center">
                                    <a href="#"><i class="fa fa-heart"></i></a>
                                    <a href="#"><i class="fa fa-random"></i></a>
                                    <a href="#"><i class="fa fa-shopping-basket"></i></a>
